      ...
      >
        {isOpen ? (
          ...
          <>
            ...
            <span
              aria-hidden="true"
              className="absolute -top-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full border-2 border-ink bg-ink-soft font-mono text-[9px] font-semibold text-lime"
            >
              B
            </span>
          </>
